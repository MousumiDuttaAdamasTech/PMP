   ...
   {{-- manage sprint section --}}
                ...
                <div class="tab-pane fade manageContent" id="manageContent" style="margin-bottom: 54px;">
                    <div id="manageContentSprint">
                        <div class="titlebar" style="display: flex; justify-content: flex-end; margin-top: 15px; margin-bottom: 20px; padding: 2px 30px; margin-right: -20px;">
        ...
        <script>
            $(document).ready(function () {
                ...
                createTaskBtn.on('click', function () {
                    createTaskForm.submit(); // Submit the form
        
                    // Assuming the form submission is successful, change the tab
                    $('#taskAssignTab').tab('show');
                    // You can add other logic or redirection here if needed
                });
            });
        </script>
