            ...
            <div class="col-md-12 mb-3">
                ...
                <div id="memberCardContainer" class="row row-cols-lg-3">
                    @foreach ($project->projectMembers as $projectMember)
                        ...
                        @endphp
                        <div class="col-md-3">
                            <div class="card member-card" data-toggle="modal" data-target="#memberDetailsModal"
                                data-member-name="{{ $projectMember->profile_name }}" data-role="{{ $roleName }}"
                                data-engagement-percentage="{{ $pivotData->engagement_percentage }}"
                                data-start-date="{{ $pivotData->start_date }}"
                                data-end-date="{{ $pivotData->end_date }}"
                                data-duration="{{ $pivotData->duration }}"
                                data-engagement-mode="{{ $pivotData->engagement_mode }}"
                                data-is-active="{{ $pivotData->is_active }}" style= "width: 222px; height: 250px;">
                                <div class="card-body mb-2" style="padding: 0 21px 0 21px;">
                                    ...
                                    <p id="card-title" class="card-title user-name" style = "font-size: 20px !important; font-weight:1000 !important;">{{ $projectMember->profile_name }}</p>
                                    <p class="card-text role"
                                    style="margin-bottom: 0rem; font-size: 15px !important; font-weight: 400; margin-top: -10px">{{ $roleName }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="modal-body">
                    <form id="addMemberForm" action="{{ route('project_members.store') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="number" id="engagement_percentage" name="engagement_percentage[]" class="form-control" required>
                            </div>
                            ...
                            <div class="col-md-12 mt-3 text-end">
                                <button type="submit" class="btn" id="addMemberBtn" style="background-color: #012970; color: white;">Add Member</button>
                            </div>
                        </div>
                    <!-- </form> -->
                </div>
